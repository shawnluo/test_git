...
# file_path = 'log-service.txt'  # Replace with the correct log file path
...
for line in filtered_lines:
    ...
    if match_camdev and match_diff and match_now:
        ...
        if camdev_number in camdev_data:
            ...
            # Store the timestamps for calculating FPS
...
# Plotting two side-by-side plots (Box plot + FPS plot)
